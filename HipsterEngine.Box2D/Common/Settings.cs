namespace Box2DX.Common
{
  public class Settings
  {
    ...
    public static readonly float AngularSlop = 0.01111111f * Settings.Pi;
    ...
    public static readonly float VelocityThreshold = 1f;
    public static readonly float MaxLinearCorrection = 0.2f;
    public static readonly float MaxAngularCorrection = 0.04444445f * Settings.Pi;
    ...
    public static readonly float AngularSleepTolerance = 0.01111111f;
    ...
    {
      return (float) System.Math.Sqrt((double) friction1 * (double) friction2);
    }

    public static float MixRestitution(float restitution1, float restitution2)
    {
      return (double) restitution1 > (double) restitution2 ? restitution1 : restitution2;
    }
  }
}