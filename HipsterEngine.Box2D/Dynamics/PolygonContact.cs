...
// Type: Box2DX.Dynamics.PolygonContact
...
namespace Box2DX.Dynamics
{
  public class PolygonContact : Contact
  {
    ...
    public override void Evaluate(ContactListener listener)
    {
      ...
      Box2DX.Collision.Collision.CollidePolygons(ref this._manifold, (PolygonShape) this._shape1, body1.GetXForm(), (PolygonShape) this._shape2, body2.GetXForm());
    ...
    {
      return (Contact) new PolygonContact(shape1, shape2);
    }
